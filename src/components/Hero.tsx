        ...
        <section ref={ref} className="relative min-h-[100svh] w-full overflow-hidden flex items-center justify-center bg-background">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-7xl lg:text-8xl font-black text-white mb-6 uppercase tracking-tight leading-[0.9]">
                    ...
                    <div className="flex flex-col items-center gap-8 mb-16">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-full shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] group hover:border-gold/30 transition-all duration-500"
                        >
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-gold opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-gold"></span>
                            </span>
                            <span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-white/60">Construction Starting At</span>
                        ...
                        <p className="text-lg md:text-2xl text-white/80 max-w-2xl mx-auto font-medium leading-relaxed">
                            ...
                            <span className="text-white border-b border-gold/30 pb-1">East Corridor.</span> Crafting spaces that define your legacy.
                        </p>
                    </div>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <a href="#contact" className="btn-gold px-10 py-4 text-base flex items-center gap-3 group rounded-xl">
                            Start Your Project
                            <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
                        </a>
                        <a href="#portfolio" className="px-10 py-4 text-base font-bold text-white border-2 border-white/20 hover:border-gold hover:text-gold transition-all duration-500 rounded-xl backdrop-blur-md uppercase tracking-[0.2em] flex items-center gap-3 group/portfolio">
                            View Portfolio

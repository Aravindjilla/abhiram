            ...
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-10 glass p-8 md:p-10 rounded-[2rem]">
                            <div>
                                <div className="flex justify-between items-center mb-6">
                                    <label className="text-sm font-bold uppercase tracking-widest text-foreground flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-2 bg-foreground/10 rounded-lg appearance-none cursor-pointer accent-gold"
                                />
                                <div className="flex justify-between text-[10px] text-foreground/30 font-bold mt-4 uppercase tracking-widest">
                                    <span>500 SFT</span>
                            ...
                            <div>
                                <label className="text-sm font-bold uppercase tracking-widest text-foreground flex items-center gap-2 mb-6">
                            ...
                            <div className="bg-gold/5 rounded-2xl p-6 border border-gold/10">
                                ...
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {quality.features.map((feature, i) => (
                                        <li key={i} className="text-[11px] font-bold text-foreground/60 flex items-center gap-2 uppercase tracking-tight">
                        ...
                        {/* Result Display */}
                        <div className="flex flex-col justify-center items-center text-center glass p-10 rounded-[2rem] bg-foreground/5 relative overflow-hidden group">

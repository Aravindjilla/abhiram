        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-marble">
                <div className="text-center">
                    <h1 className="text-4xl font-black text-charcoal mb-4">POST NOT FOUND</h1>
                    <Link href="/blog" className="text-gold font-bold uppercase tracking-widest text-sm hover:underline">
